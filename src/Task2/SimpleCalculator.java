...
public class SimpleCalculator {
    public static void main(String[] args) {
        ...
        if (pembagian!=null) {
            ...
            System.out.printf("pembagian(%.4f/%.4f)= tidak terdefinisi (pembagian 0)%n",angka1,angka2);
        }
        if(modulus!=null){
            System.out.printf("Modulus(%.4f%%% .4f)=%.4f%n",angka1,angka2,modulus);
        }else {
            System.out.printf("Modulus(%.4f%%%.4f)= Tidak terdefinisi(pembagian 0)%n", angka1, angka2);
        }
